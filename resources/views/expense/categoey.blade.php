                        ...
                        <form class="pt-3" id="create-form" action="{{ route('expense-category.store') }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input name="name" type="text" required placeholder="{{ __('name') }}" class="form-control"/>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table table-striped' id='table_list' data-toggle="table"
                               ...
                               data-toolbar="#toolbar" data-export-options='{ "fileName": "expense-category-list-<?= date('d-m-y') ?>" ,"ignoreColumn":["operate"]}' data-show-export="true">
                            <thead>
                            <tr>
                                ...
                                <th scope="col" data-field="operate" data-events="expenseCategoryEvents">{{ __('action') }}</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
